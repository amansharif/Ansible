...
```
ansible-playbook -i inventory tomcat_installation_playbook.yml -u ec2-user
```
##Uninstallation Command

```
ansible-playbook -i inventory tomcat_installation_playbook.yml -u ec2-user -e tomcat_state=absent
```
